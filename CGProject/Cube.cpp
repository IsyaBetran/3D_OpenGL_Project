...
void Cube::InitData()
{
	...
	float vertices[] = {
		...
		// right face
		0.5,  0.5,  0.5,   0, 1,  1.0f,  0.0f,  0.0f, // 4
		0.5,  0.5, -0.5,   1, 1,  1.0f,  0.0f,  0.0f, // 5
		0.5, -0.5, -0.5,   1, 0,  1.0f,  0.0f,  0.0f, // 6
		0.5, -0.5,  0.5,   0, 0,  1.0f,  0.0f,  0.0f, // 7

		// back face
		-0.5,  -0.5, -0.5, 1, 0,  0.0f,  0.0f,  1.0f, // 8 
		 0.5,  -0.5, -0.5, 0, 0,  0.0f,  0.0f,  1.0f, // 9
		 0.5,   0.5, -0.5, 0, 1,  0.0f,  0.0f,  1.0f, // 10
		-0.5,   0.5, -0.5, 1, 1,  0.0f,  0.0f,  1.0f, // 11
		...
		// upper face
		 0.5, 0.5,  0.5,   0, 1,   0.0f,  1.0f,  0.0f, // 16
		-0.5, 0.5,  0.5,   1, 1,   0.0f,  1.0f,  0.0f, // 17
		-0.5, 0.5, -0.5,   1, 0,   0.0f,  1.0f,  0.0f, // 18
		 0.5, 0.5, -0.5,   0, 0,   0.0f,  1.0f,  0.0f, // 19
	...
	unsigned int indices[] = {
		...
		6,  5,  4,   7,  6,  4,   // right face
		10,  9,  8,  11,  10, 8,  // back face
		12, 13, 14,  12, 14, 15,  // left face
		18, 17, 16,  19, 18, 16,  // upper face
